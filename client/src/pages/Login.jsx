          ...
          <div className="glass rounded-2xl p-8">
            ...
            <form onSubmit={submit} className="space-y-4">
              ...
              <motion.button
                ...
                type="submit"
                disabled={loading}
                className="w-full py-3 gradient-accent text-white text-sm font-semibold rounded-xl shadow-lg shadow-accent/20 hover:shadow-accent/30 transition-shadow disabled:opacity-50"
              >
