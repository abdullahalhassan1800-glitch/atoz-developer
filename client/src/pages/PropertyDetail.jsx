                ...
                <div className="mt-6">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                    {property.features.map((f, i) => (
                      <div key={i} className="flex items-center gap-2 text-sm font-light text-white/50 p-2.5 glass rounded-xl">
            ...
            <div className="glass-card rounded-2xl p-6">
              ...
              {sent ? (
                ...
                <form onSubmit={send} className="space-y-3">
                  ...
                  <button type="submit" className="w-full py-3 gradient-accent text-white text-sm font-semibold rounded-xl shadow-lg shadow-accent/20 hover:shadow-accent/30 transition-all">
                    Send Message
                  </button>
                </form>
              )}
