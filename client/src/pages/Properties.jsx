...
export default function Properties() {
  ...
  const sel = "py-3 px-4 bg-white border border-slate-200 rounded-xl text-slate-700 text-sm font-light outline-none focus:border-accent focus:ring-2 focus:ring-sky-100 transition-all appearance-none cursor-pointer";
    ...
    <div className="min-h-screen bg-deep">
      ...
      <section className="pt-24 pb-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <FadeIn delay={0.1}>
            <h1 className="text-3xl sm:text-4xl font-bold text-slate-800 mt-3 mb-3">Find Your Perfect Property</h1>
          </FadeIn>
          <FadeIn delay={0.2}>
            <p className="text-sm text-slate-400">{pagination.total} properties available</p>
          </FadeIn>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 mb-10 border border-slate-200 shadow-soft">
            <form onSubmit={search}>
              <div className="grid grid-cols-1 sm:grid-cols-4 gap-3">
                ...
                <button type="submit" className="py-3 gradient-accent text-white text-sm font-semibold rounded-xl shadow-medium hover:shadow-strong transition-shadow flex items-center justify-center gap-2">
                  <FaSearch className="text-xs" /> Search
                </button>
              </div>

              <button type="button" onClick={() => setShowFilters(!showFilters)} className="mt-4 text-xs font-medium text-accent flex items-center gap-2 hover:text-accent-dark transition-colors">
        ...
        {loading ? (
          ...
          <div className="text-center py-24">
            ...
            <p className="text-xl font-bold text-slate-800 mb-2">No properties found</p>
                  ...
                  <button
                    ...
                    className={`w-10 h-10 rounded-xl text-sm font-medium transition-all ${
                      pagination.currentPage === page
                        ...
                        : 'bg-white border border-slate-200 text-slate-400 hover:text-accent hover:border-sky-300'
                    }`}
                  >
                    {page}
                  </button>
