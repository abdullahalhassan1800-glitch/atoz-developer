          ...
          <div className="glass rounded-2xl p-8">
            ...
            {error && (
              <motion.div
                ...
                className="bg-red-500/10 border border-red-500/20 text-red-400 text-sm p-3 rounded-xl mb-4 font-light"
              >
                {error}
              </motion.div>
            )}
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[{ v: 'buyer', l: 'Buyer / Renter' }, { v: 'agent', l: 'Property Agent' }].map((o) => (
                    <motion.button
                      ...
                      className={`py-3 rounded-xl text-sm font-medium border transition-all duration-300 ${form.role === o.v ? 'border-accent bg-accent/10 text-accent' : 'border-white/10 text-white/40 hover:border-white/20'}`}
                    >
                      {o.l}
                    </motion.button>
                  ))}
